...
public class AESUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("加密后："+AESUtil.encrypt(data, KEY));
        System.out.println("解密后："+AESUtil.decrypt(AESUtil.encrypt(data, KEY), KEY));
        System.out.println("1231231"+data.equals(AESUtil.decrypt(AESUtil.encrypt(data, KEY), KEY)));
